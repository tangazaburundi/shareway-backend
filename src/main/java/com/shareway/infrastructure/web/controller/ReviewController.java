...
@Tag(name = "Reviews", description = "Avis et notation (passager → conducteur et conducteur → passager)")
public class ReviewController {

    private final ReviewUseCase reviewUseCase;

    // ─────────────────────────────────────────────────────────────────────
    // Avis reçus par un utilisateur (sa page profil)
    // ─────────────────────────────────────────────────────────────────────
    ...
    // ─────────────────────────────────────────────────────────────────────
    // Vérifier si je peux encore laisser un avis (pour le frontend)
    // ─────────────────────────────────────────────────────────────────────
    @GetMapping("/can-review")
    @SecurityRequirement(name = "bearerAuth")
    @Operation(
            summary = "Puis-je encore noter ?",
            description = "Retourne true si l'utilisateur connecté n'a pas encore noté " +
                    "la cible pour ce trajet. Params: tripId, targetId"
    )
    ...
    // ─────────────────────────────────────────────────────────────────────
    // Créer un avis (passager → conducteur OU conducteur → passager)
    // ─────────────────────────────────────────────────────────────────────
    @PostMapping
    @SecurityRequirement(name = "bearerAuth")
    @Operation(
            summary = "Laisser un avis",
            description = "Un passager peut noter le conducteur d'un trajet COMPLETED auquel il a participé. " +
                    "Un conducteur peut noter un passager qui a réservé son trajet. " +
                    "Un seul avis par paire (trip × author × target)."
    )
    ...
    public ResponseEntity<ApiResponse<Void>> flag(
        ...
        return ResponseEntity.ok(ApiResponse.noContent("Review reported"));
    }
}
*/
